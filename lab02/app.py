...
#########################
current_user = CurrentUser(first_name='Bill', last_name='Yin', email='erub03@gmail.com', username='erub03')
...
@app.route('/')
def exercise1():
    return "Greetings, " + current_user.get_full_name() + ". How was your day?"
